...
class GPUEmbeddingBaseTest(parameterized.TestCase, test.TestCase):
  ...
  def _check_results(self, strategy, shard_out_val, training, input_data,
    ...
    print('_check_results 0', 'num replica ', num_replicas, 'self.batch_size', self.batch_size)
    print('shard_out_val', shard_out_val)
    print('_check_results 1')
    ...
    print('activation_watched 1')
    print(activation_watched)
