...
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(DEFINE_SORTED_GPU_SPECS);
...
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(DEFINE_REAL_GPU_SPECS);
TF_CALL_int32(DEFINE_REAL_GPU_SPECS);
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(DEFINE_SUM_GPU_SPECS);
