...
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(REGISTER_SCATTER_ND_ALL_GPU);
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(REGISTER_SCATTER_ND_MIN_MAX_GPU);
...
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(DECLARE_GPU_SPECS);
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(DECLARE_GPU_SPECS_MIN_MAX);
