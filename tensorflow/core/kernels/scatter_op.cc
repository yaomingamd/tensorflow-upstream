...
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(REGISTER_SCATTER_ARITHMETIC_GPU);
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(REGISTER_SCATTER_MINMAX_GPU);
TF_CALL_GPU_NUMBER_TYPES_NO_BF16(REGISTER_SCATTER_UPDATE_GPU);
